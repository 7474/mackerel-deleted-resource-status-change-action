...
exports.IntegratedHost = IntegratedHost;
var MackerelIntegration = /** @class */ (function () {
    function MackerelIntegration(mackerelConfig) {
    ...
    MackerelIntegration.prototype.getHosts = function (condition) {
        return __awaiter(this, void 0, void 0, function () {
            var response, integratedHosts;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mackerel.host.getHosts(condition.service, condition.role, undefined, condition.status, undefined)];
                    case 1:
                        response = _a.sent();
                        integratedHosts = response.body.hosts
                            .filter(function (x) {
                            ...
                            .map(function (x) {
                            try {
                                return new IntegratedHost(_this, x, _this.cloudResourceFactory.of(x));
                            }
                            catch (err) {
                                console.error(err);
                                return undefined;
                        ...
                        return [2 /*return*/, integratedHosts];
                }
            });
        });
    };
    return MackerelIntegration;
}());
exports.MackerelIntegration = MackerelIntegration;
